...
// Komponen terpisah untuk routes yang membutuhkan Layout
  ...
  return (
    <Layout>
      <Routes>
        ...
        {/* Finance Department */}
        {/* laporan-keuangan */}
        <Route path="/fn-dept/laporan-keuangan/laporan-laba-rugi" element={<ProfitLossReportPage />} />
        <Route path="/fn-dept/laporan-keuangan/laporan-arus-kas" element={<CashFlowReportPage />} />
        ...
        <Route path="/fn-dept/vendor-pembayaran/kelola-faktur" element={<ManageIncomingInvoicesPage />} />
        <Route path="/fn-dept/vendor-pembayaran/daftar-vendor" element={<ActiveVendorListPage />} />
        ...
        {/* Not Found for paths within Layout */}
